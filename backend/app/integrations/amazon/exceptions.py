...
AMAZON_CATALOG_SNAPSHOT_NOT_FOUND = "AMAZON_CATALOG_SNAPSHOT_NOT_FOUND"
...
def amazon_catalog_snapshot_not_found_error() -> AmazonError:
    return AmazonError(
        "Amazon catalog snapshot was not found",
        error_code=AMAZON_CATALOG_SNAPSHOT_NOT_FOUND,
        status_code=422,
    )
