  ...
  return (
    <PublicPageShell>
      <article className="mx-auto max-w-4xl px-5 py-16 sm:py-20">
        ...
        <p className="mt-7 text-xl leading-9 text-slate-600">Listnara is an independent software product for Amazon sellers who want a structured review of listing content—not another ungrounded block of generated copy.</p>
